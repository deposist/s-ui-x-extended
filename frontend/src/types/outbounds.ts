...
const defaultValues: Record<OutType, Outbound> = {
  ...
  sudoku: { type: OutTypes.Sudoku, key: '' },
  trusttunnel: { type: OutTypes.TrustTunnel, network: ['tcp', 'udp'], tls: { enabled: true } },
  ...
  openvpn: { type: OutTypes.OpenVPN, servers: [{ server: '', server_port: 1194 }], proto: 'udp', tls: {} },
