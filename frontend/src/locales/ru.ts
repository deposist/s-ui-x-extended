export default {
  ...
  types: {
    ...
    provider: {
      url: "URL подписки",
      path: "Путь к файлу подписки",
      userAgent: "User agent",
      downloadDetour: "Исходящий для загрузки",
      updateInterval: "Интервал обновления",
      include: "Включить (regex)",
      exclude: "Исключить (regex)",
      removeEmojis: "Удалять эмодзи",
      outbounds: "Исходящие",
      outboundsHint: "JSON-массив конфигураций исходящих, предоставляемых этим провайдером",
      outboundsArrayError: "Исходящие должны быть JSON-массивом",
      healthCheck: "Проверка работоспособности",
      healthUrl: "URL проверки",
      healthInterval: "Интервал",
      healthTimeout: "Тайм-аут",
    },
    vpn: {
      ...
      inbounds: "Входящие",
      inboundsHint: "JSON-массив входящих конфигураций, обрабатываемых этим VPN-сервером",
      inboundsArrayError: "Входящие должны быть JSON-массивом",
      outbound: "Исходящее",
      outboundHint: "JSON-объект исходящей конфигурации, используемой этим VPN-клиентом",
      outboundObjectError: "Исходящее должно быть JSON-объектом",
    },
    sdns: {
      stamp: "DNS-штамп",
      stampHint: "Штамп сервера DNSCrypt (sdns://...)",
    },
    fallback: {
      servers: "Вышестоящие серверы",
      serversHint: "Теги DNS-серверов для последовательного перебора",
      strategy: "Стратегия",
    },
    mieru: {
      transport: "Транспорт",
      multiplexing: "Мультиплексинг",
      userHint: "Обязательная подсказка пользователя",
      serverPorts: "Порты сервера (диапазоны)",
      listenPorts: "Порты прослушивания (диапазоны)",
      trafficPattern: "Паттерн трафика",
    },
    sudoku: {
      key: "Ключ",
      aeadMethod: "AEAD-метод",
      tableType: "Тип таблицы",
      paddingMin: "Padding мин.",
      paddingMax: "Padding макс.",
      handshakeTimeout: "Таймаут рукопожатия (с)",
      pureDownlink: "Чистый downlink",
      customTable: "Своя таблица",
      customTables: "Свои таблицы",
      httpMask: "HTTP-маскировка",
      httpMaskMode: "Режим HTTP-маскировки",
      disableHttpMask: "Отключить HTTP-маскировку",
      multiplex: "Мультиплекс",
      host: "Host",
      pathRoot: "Корень пути",
      fallback: "Fallback",
    },
    trusttunnel: {
    ...
    openvpn: {
      ...
      proto: "Протокол",
      cipher: "Шифр",
      auth: "Дайджест аутентификации",
      keyDirection: "Направление ключа",
      pingInterval: "Интервал ping",
      reconnectDelay: "Задержка переподключения",
      staticKey: "Статический ключ (tls-crypt / tls-auth)",
      tlsCrypt: "TLS Crypt",
      ...
      ca: "Сертификат CA",
      caPath: "Путь к сертификату CA",
      verifyX509Name: "Проверка имени X.509",
      verifyX509NameMode: "Режим проверки имени X.509",
    },
    amnezia: {
      title: "Amnezia (обфускация)",
      jc: "Количество мусорных пакетов (Jc)",
      jmin: "Мин. размер мусорного пакета (Jmin)",
      jmax: "Макс. размер мусорного пакета (Jmax)",
      s1: "Размер мусора init-пакета (S1)",
      s2: "Размер мусора ответного пакета (S2)",
      s3: "Размер мусора cookie reply (S3)",
      s4: "Размер мусора транспортного пакета (S4)",
      h1: "Магический заголовок init-пакета (H1)",
      h2: "Магический заголовок ответного пакета (H2)",
      h3: "Магический заголовок underload-пакета (H3)",
      h4: "Магический заголовок транспортного пакета (H4)",
      i1: "Специальный мусорный пакет 1 (I1)",
      i2: "Специальный мусорный пакет 2 (I2)",
      i3: "Специальный мусорный пакет 3 (I3)",
      i4: "Специальный мусорный пакет 4 (I4)",
      i5: "Специальный мусорный пакет 5 (I5)",
      j1: "Специальный мусорный пакет 1 (J1)",
      j2: "Специальный мусорный пакет 2 (J2)",
      j3: "Специальный мусорный пакет 3 (J3)",
      itime: "Таймаут спец. мусора (Itime)",
    },
    mtproxy: {
      proxyProtocol: "Proxy-протокол",
      doppelganger: "Doppelganger",
      drs: "DRS",
      preferIp: "Предпочтение IP",
      concurrency: "Параллелизм",
      autoUpdate: "Автообновление списка прокси",
      domainFronting: "Domain fronting",
      frontingHost: "Хост фронтинга",
      idleTimeout: "Таймаут простоя",
      handshakeTimeout: "Таймаут рукопожатия",
      timeSkew: "Допустимый сдвиг времени",
      throttleMax: "Макс. соединений (throttle)",
      throttleInterval: "Интервал проверки throttle",
      fallbackUnknownDc: "Разрешить fallback на неизвестный DC",
      doppelUrls: "Doppelganger URL",
      doppelPerRaid: "Doppelganger за рейд",
      doppelEach: "Doppelganger период",
    },
    direct: {
    ...
    ssh: {
      ...
      hostKey: "Ключи хоста",
      hostKeyPath: "Пути к ключам хоста",
      serverVersion: "Версия сервера",
      maxAuthTries: "Макс. попыток аутентификации",
    ...
    vless: {
      ...
      encryptionHint: "Строка шифрования Xray VLESS (оставьте пустым, чтобы отключить)",
      decryption: "Дешифрование",
      decryptionHint: "Строка дешифрования Xray VLESS (оставьте пустым, чтобы отключить)",
    },
    vmess: {
    ...
    group: {
      ...
      outboundConfig: "Конфигурация исходящего (JSON)",
      invalidJson: "Некорректный JSON",
      ratioHint: "Сумма коэффициентов загрузки и отдачи должна быть 100",
      downloadRatio: "Коэффициент загрузки",
      uploadRatio: "Коэффициент отдачи",
      count: "Количество",
      strategy: "Стратегия",
      strategySequential: "Последовательная",
      strategyCycle: "Циклическая",
      delay: "Задержка"
    },
    limiter: {
      strategy: "Стратегия",
      ...
      count: "Количество",
      interval: "Интервал",
      flowKeys: "Ключи потока",
      users: "Пользователи",
      userName: "Имя",
      route: "Маршрутизация",
      final: "Конечный outbound",
      rules: "Правила (JSON-массив)",
    },
    ts: {
    ...
    profiler: {
      readTimeout: "Тайм-аут чтения",
      writeTimeout: "Тайм-аут записи",
    },
    parser: {
      link: "Ссылка",
      linkHint: "Ссылка подписки/обмена (hysteria, hysteria2, shadowsocks, trojan, tuic, vless, vmess)",
    },
  },
  in: {
    addr: "Адрес",
  ...
  transport: {
    ...
    mkcpMtu: "MTU",
    mkcpTti: "TTI",
    mkcpUplink: "Пропускная способность исходящего",
    mkcpDownlink: "Пропускная способность входящего",
    mkcpReadBuffer: "Размер буфера чтения",
    mkcpWriteBuffer: "Размер буфера записи",
    mkcpHeaderType: "Тип заголовка",
    mkcpCongestion: "Контроль перегрузки",
    mkcpSeed: "Сид",
    xhttpMode: "Режим",
    xhttpDomainStrategy: "Стратегия домена",
    xhttpPaddingBytes: "Байты заполнения",
    xhttpScMaxEachPostBytes: "Макс. байт на запрос",
    xhttpScMinPostsIntervalMs: "Мин. интервал запросов (мс)",
    xhttpScStreamUpServerSecs: "Секунды stream-up на сервере",
    xhttpScMaxBufferedPosts: "Макс. буферизованных запросов",
    xhttpServerMaxHeaderBytes: "Макс. байт заголовка сервера",
    xhttpNoGrpcHeader: "Без gRPC-заголовка",
    xhttpNoSseHeader: "Без SSE-заголовка",
    xhttpTrustedXff: "Доверенные X-Forwarded-For",
    xhttpDownload: "Отдельный канал загрузки",
    xhttpPaddingObfs: "Заполнение и обфускация",
    xhttpPaddingObfsMode: "Режим обфускации заполнения",
    xhttpPaddingKey: "Ключ заполнения",
    xhttpPaddingHeader: "Заголовок заполнения",
    xhttpPaddingPlacement: "Размещение заполнения",
    xhttpPaddingMethod: "Метод заполнения",
    xhttpPlacement: "Размещение и ключи",
    xhttpUplinkHttpMethod: "HTTP-метод исходящего",
    xhttpSessionPlacement: "Размещение сессии",
    xhttpSessionKey: "Ключ сессии",
    xhttpSeqPlacement: "Размещение последовательности",
    xhttpSeqKey: "Ключ последовательности",
    xhttpUplinkDataPlacement: "Размещение данных исходящего",
    xhttpUplinkDataKey: "Ключ данных исходящего",
    xhttpUplinkChunkSize: "Размер блока исходящего",
    xhttpXmux: "XMUX",
    xmuxMaxConcurrency: "Макс. параллельность",
    xmuxMaxConnections: "Макс. соединений",
    xmuxCMaxReuseTimes: "Макс. повторов соединения",
    xmuxHMaxRequestTimes: "Макс. запросов (H)",
    xmuxHMaxReusableSecs: "Макс. секунд повтора (H)",
    xmuxHKeepAlivePeriod: "Период Keep Alive (H)",
  },
  mux: {
