export default {
  ...
  types: {
    ...
    provider: {
      ...
      outbounds: "Outbounds",
      outboundsHint: "JSON array of outbound configs served by this provider",
    ...
    vpn: {
      ...
      inbounds: "Inbounds",
      inboundsHint: "JSON array of inbound configs handled by this VPN server",
      inboundsArrayError: "Inbounds must be a JSON array",
      outbound: "Outbound",
      outboundHint: "JSON object of the outbound config used by this VPN client",
      outboundObjectError: "Outbound must be a JSON object",
    },
    sdns: {
      stamp: "DNS Stamp",
      stampHint: "DNSCrypt server stamp (sdns://...)",
    },
    fallback: {
      servers: "Upstream servers",
      serversHint: "Tags of DNS servers to fall back through",
      strategy: "Strategy",
    },
    mieru: {
      transport: "Transport",
      multiplexing: "Multiplexing",
      userHint: "Mandatory user hint",
      serverPorts: "Server ports (ranges)",
      listenPorts: "Listen ports (ranges)",
    ...
    sudoku: {
      ...
      handshakeTimeout: "Handshake timeout (s)",
    ...
    masque: {
      ...
      udpKeepalive: "UDP keepalive period",
    ...
    openvpn: {
      ...
      reconnectDelay: "Reconnect delay",
      staticKey: "Static key (tls-crypt / tls-auth)",
      tlsCrypt: "TLS Crypt",
    ...
    amnezia: {
      ...
      jmin: "Junk packet min size (Jmin)",
      jmax: "Junk packet max size (Jmax)",
      s1: "Init packet junk size (S1)",
      s2: "Response packet junk size (S2)",
      s3: "Cookie reply junk size (S3)",
      s4: "Transport packet junk size (S4)",
      h1: "Init packet magic header (H1)",
      h2: "Response packet magic header (H2)",
      h3: "Underload packet magic header (H3)",
      h4: "Transport packet magic header (H4)",
      i1: "Special junk packet 1 (I1)",
      i2: "Special junk packet 2 (I2)",
      i3: "Special junk packet 3 (I3)",
      i4: "Special junk packet 4 (I4)",
      i5: "Special junk packet 5 (I5)",
      j1: "Special junk packet 1 (J1)",
      j2: "Special junk packet 2 (J2)",
      j3: "Special junk packet 3 (J3)",
      itime: "Special junk timeout (Itime)",
    },
    mtproxy: {
      proxyProtocol: "Proxy Protocol",
      doppelganger: "Doppelganger",
      drs: "DRS",
      preferIp: "IP preference",
      concurrency: "Concurrency",
      autoUpdate: "Auto update proxy list",
      domainFronting: "Domain fronting",
      frontingHost: "Fronting host",
      idleTimeout: "Idle timeout",
      handshakeTimeout: "Handshake timeout",
      timeSkew: "Tolerate time skewness",
      throttleMax: "Throttle max connections",
      throttleInterval: "Throttle check interval",
      fallbackUnknownDc: "Allow fallback on unknown DC",
      doppelUrls: "Doppelganger URLs",
      doppelPerRaid: "Doppelganger per raid",
      doppelEach: "Doppelganger each",
    },
    direct: {
    ...
    vless: {
      ...
      encryptionHint: "Xray VLESS encryption string (leave empty to disable)",
      decryption: "Decryption",
      decryptionHint: "Xray VLESS decryption string (leave empty to disable)",
    },
    vmess: {
      security: "Security",
    ...
    group: {
      ...
      outboundConfig: "Outbound config (JSON)",
      invalidJson: "Invalid JSON",
      ratioHint: "Sum of download and upload ratios must be 100",
    ...
    parser: {
      link: "Share Link",
      linkHint: "Subscription/share link (hysteria, hysteria2, shadowsocks, trojan, tuic, vless, vmess)",
    },
  },
  in: {
    addr: "Address",
  ...
  transport: {
    ...
    mkcpReadBuffer: "Read Buffer Size",
    mkcpWriteBuffer: "Write Buffer Size",
    mkcpHeaderType: "Header Type",
    mkcpCongestion: "Congestion",
    mkcpSeed: "Seed",
    xhttpMode: "Mode",
    xhttpDomainStrategy: "Domain Strategy",
    xhttpPaddingBytes: "Padding Bytes",
    xhttpScMaxEachPostBytes: "Max Each Post Bytes",
    xhttpScMinPostsIntervalMs: "Min Posts Interval (ms)",
    xhttpScStreamUpServerSecs: "Stream Up Server Secs",
    xhttpScMaxBufferedPosts: "Max Buffered Posts",
    xhttpServerMaxHeaderBytes: "Server Max Header Bytes",
    xhttpNoGrpcHeader: "No gRPC Header",
    xhttpNoSseHeader: "No SSE Header",
    xhttpTrustedXff: "Trusted X-Forwarded-For",
    xhttpDownload: "Separate Download Channel",
    xhttpPaddingObfs: "Padding & Obfuscation",
    xhttpPaddingObfsMode: "Padding Obfs Mode",
    ...
    xhttpXmux: "XMUX",
    xmuxMaxConcurrency: "Max Concurrency",
    xmuxMaxConnections: "Max Connections",
    xmuxCMaxReuseTimes: "Conn Max Reuse Times",
    xmuxHMaxRequestTimes: "H Max Request Times",
    xmuxHMaxReusableSecs: "H Max Reusable Secs",
    xmuxHKeepAlivePeriod: "H Keep Alive Period",
  },
  mux: {
