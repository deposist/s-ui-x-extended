...
| Beta | [`v1.0.8-beta6`](docs/releases/v1.0.8-beta6.md) | For testing. Adds locally materialized regional rule-sets, nested route and DNS conditions, UI and accessibility fixes, and a rebased `sing-box-extended` core. |
