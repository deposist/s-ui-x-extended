...
- Latest stable notes: [`docs/releases/v1.0.2-beta1.md`](docs/releases/v1.0.2-beta1.md)
...
|---|---|---|
| Stable | `v1.0.2-beta1` | Recommended for production. Adds managed AmneziaWG 2.0 devices and fixes the saved-language `s-ui` menu startup. Release notes: [`docs/releases/v1.0.2-beta1.md`](docs/releases/v1.0.2-beta1.md). |
...
- Stable: download `v1.0.2-beta1` from [its release page](https://github.com/deposist/s-ui-x-extended/releases/tag/v1.0.2-beta1), extract the ZIP, and run `install-windows.bat` as Administrator.
...
2. Optional: download the latest `s-ui.sh`: [https://raw.githubusercontent.com/deposist/s-ui-x-extended/v1.0.2-beta1/s-ui.sh](https://raw.githubusercontent.com/deposist/s-ui-x-extended/v1.0.2-beta1/s-ui.sh)
