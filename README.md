...
| Beta | `v1.0.1-beta2` | Latest beta release. Includes guided configuration forms and the Dashboard traffic timezone selector. Release notes: [`.github/RELEASE_NOTES_v1.0.1-beta2.md`](.github/RELEASE_NOTES_v1.0.1-beta2.md). |
