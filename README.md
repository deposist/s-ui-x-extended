...
| Beta | [`v1.1.1-beta7`](docs/releases/v1.1.1-beta7.md) | AmneziaWG 3.1 switches (random trailers, disable cookies) in the WireGuard endpoint form; core updated to `v1.14.0-extended-2.7.5`. |
...
This command installs or upgrades the server to `v1.1.1-beta7`:
...
- Beta: download [`v1.1.1-beta7`](https://github.com/deposist/s-ui-x-extended/releases/tag/v1.1.1-beta7), extract the matching ZIP archive, and run `install-windows.bat` as Administrator.
