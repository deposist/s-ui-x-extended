...
|---|---|---|
| Stable | `v1.0.2` | Recommended for production. AmneziaWG 2.0 servers are configured as endpoints and assigned to clients like inbounds; devices are delivered through the panel and Telegram. Release notes: [`docs/releases/v1.0.2.md`](docs/releases/v1.0.2.md). |
