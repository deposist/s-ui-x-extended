...
| Beta | [`v1.1.1-beta6`](docs/releases/v1.1.1-beta6.md) | Fixes core shutdown and restart hanging when MTProxy is enabled. |
...
This command installs or upgrades the server to `v1.1.1-beta6`:
...
- Beta: download [`v1.1.1-beta6`](https://github.com/deposist/s-ui-x-extended/releases/tag/v1.1.1-beta6), extract the matching ZIP archive, and run `install-windows.bat` as Administrator.
