...
| Beta | [`v1.0.8-beta6`](docs/releases/v1.0.8-beta6.md) | Для тестирования. Добавлены локальные региональные наборы правил, вложенные условия маршрутизации и DNS, исправления интерфейса и доступности, а также обновлённое ядро `sing-box-extended`. |
