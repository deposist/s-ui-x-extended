...
| Beta | [`v1.0.8-beta7`](docs/releases/v1.0.8-beta7.md) | Для тестирования. Исправлена загрузка российского регионального пресета после удаления исходного geosite-файла. |
