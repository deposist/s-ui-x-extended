...
|---|---|---|
| Stable | `v1.0.2` | Рекомендуется для production. Добавляет управляемые устройства AmneziaWG 2.0 и исправляет запуск меню `s-ui` с сохранённым языком. Release notes: [`docs/releases/v1.0.2.md`](docs/releases/v1.0.2.md). |
