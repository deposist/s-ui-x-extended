...
- Заметки последней опубликованной beta-версии: [`.github/RELEASE_NOTES_v1.0.1-beta4.md`](.github/RELEASE_NOTES_v1.0.1-beta4.md)
...
| Beta | `v1.0.1-beta4` | Последняя beta. Исправляет сохранение WARP endpoint со schema sing-box-extended, которая используется в этой сборке. Release notes: [`.github/RELEASE_NOTES_v1.0.1-beta4.md`](.github/RELEASE_NOTES_v1.0.1-beta4.md). |
...
- Beta: `v1.0.1-beta4` доступна на [странице релиза](https://github.com/deposist/s-ui-x-extended/releases/tag/v1.0.1-beta4).
