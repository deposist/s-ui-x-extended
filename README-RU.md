...
- Заметки последней опубликованной beta-версии: [`.github/RELEASE_NOTES_v1.0.1-beta1.md`](.github/RELEASE_NOTES_v1.0.1-beta1.md)
...
| Beta | `v1.0.1-beta1` | Последняя опубликованная beta. Используйте ее для проверки pre-release изменений. Release notes: [`.github/RELEASE_NOTES_v1.0.1-beta1.md`](.github/RELEASE_NOTES_v1.0.1-beta1.md). |
...
- Beta: `v1.0.1-beta1` доступна на [странице релиза](https://github.com/deposist/s-ui-x-extended/releases/tag/v1.0.1-beta1).
