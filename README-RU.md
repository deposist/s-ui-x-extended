...
| Beta | [`v1.0.8-beta8`](docs/releases/v1.0.8-beta8.md) | Для тестирования. Восстанавливает обновления в реальном времени после ошибки запроса WebSocket-токена без сети и исправляет запуск frontend-тестов в Windows. |
